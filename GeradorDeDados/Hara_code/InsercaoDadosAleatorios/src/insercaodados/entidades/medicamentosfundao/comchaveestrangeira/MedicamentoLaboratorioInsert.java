...
public class MedicamentoLaboratorioInsert extends Insert implements InsertPostgreSql{
    public int fkIdMedicamento;
    public int fkIdLaboratorio;

    public MedicamentoLaboratorioInsert() {
    }
    
    public MedicamentoLaboratorioInsert(String sqlQueryInsert) {
    ...
    public String createInsertQueryPostgreSql(String... params) {
        super.insertSql = String.format("INSERT INTO %s (%s, %s) VALUES (%d, %d);"
            , params[0], params[1], params[2], this.fkIdMedicamento, this.fkIdLaboratorio);
